...
\end{equation}
are discretised in space with CV basis functions, and in time with the $\theta$-method \cite{pavlidis2016}. In Eqn.~\ref{saturation_equation}, $\phi$ is the porosity and $s_{cty}$ is a source term.
