...
Figure~\ref{fig:PermFields} show permeability distribution for cases simulated here


compares the permeability distribution for all the models. As indicated in the figure's caption, the permeability legend in Fig.~\ref{fig:PermFields}(a) is representative for all the other figures (\ie Fig.~\ref{fig:PermFields}(b) to (f)). Additionally, Fig.~\ref{fig:PermFields}(b) to (f) show the cases without the element edges which discretize the domain.
