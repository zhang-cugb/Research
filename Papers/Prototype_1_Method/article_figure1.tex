...
\caption{2D representation of the element-pairs (a) \PN[0]{1}, (b) \PN[1]{2} and (c) \PNDG[2]{1}. Shaded areas denote a control volumes (in which saturation is stored), black points represent the pressure nodes and the white points the velocity.}
