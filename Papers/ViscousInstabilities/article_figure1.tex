...
\caption{Impact of mesh resolution on flow instabilities: (a) schematics of the domain depicting four regions with prescribed synthetic permeabilities; (b) there is a comparison between the unstructured and fixed mesh and the unstructured and adaptive mesh. During the implementation of fixed mesh initially there $4606$ elements while for the adaptive mesh there are $606$ while the majority of them is on the interface between between the two fluids. }
...
\begin{landscape}
  ...
  \vbox{\vspace{-.5cm}
      ...
      \hbox{\hspace{2.0cm} (a) t=XXXs \hspace{6.cm} (b) t=XXXs \hspace{4.cm} (c) t=XXXs}
      \vspace{0.5cm}
      \hbox{\hspace{.5cm} \includegraphics[width=.45\textwidth]{./Pics1/3D_Channel/3D_Channel_Saturation1Isosurface_D110c}
            ...
            \includegraphics[width=.45\textwidth]{./Pics1/3D_Channel/3D_Channel_Saturation1Isosurface_D300c} }
      \hbox{\hspace{3.cm} (d) t=XXXs \hspace{3.cm} (e) t= XXXs\hspace{4.cm} (f) t=XXXs }}
\caption{XXX.}
