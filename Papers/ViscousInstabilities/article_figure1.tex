...
%}
%}     
\caption{Impact of mesh resolution on flow instabilities: permeability distribution with initial grid resolution used in the simulations performed in Section~\ref{section:results_hete_fix_adapt}. There are 13068 \PN[1]{2} element-pairs in the domain.}
