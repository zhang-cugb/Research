...
\hbox{\hspace{1cm}
\includegraphics[width=\textwidth]{./Pics1/Five_regions_adapt_MeshPerm}}
\vspace{-1.0cm}
\hbox{\hspace{3.5cm} (a) Permeability mapping ({\bf K})}
\vspace{0.0cm}
\hbox{\hspace{1cm}
\includegraphics[width=\textwidth]{./Pics1/Five_regions_adapt_MeshSat1}}
\vspace{-1.0cm}
...
%%%%
\begin{figure}[ht] 
\includegraphics[width=\textwidth]{./Pics1/Five_regions_adapt_PlotTimeNodesElements}
