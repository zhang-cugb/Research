...
\vbox{
\hbox{\hspace{0.5cm}
\includegraphics[width=0.5\textwidth]{./Pics1/3D_Channel/3D_channel_sat_end.pdf} 
}
\vspace{-12.0cm}
\hbox{\hspace{6.0cm} (a)     
}
\hbox{\hspace{0.5cm}
\includegraphics[width=0.5\textwidth]{./Pics1/3D_Channel/3D_channel_sat_adapt_end.pdf}
}
\vspace{-12.0cm}
\hbox{\hspace{6.0cm} (b)      
}
}     
\caption{\red{The XY and YZ plabes, this is a description of the Darcy velocity vectors for (a) t=$0.29$s and (b)t=$4.3$s.}
\label{fig:3DChannel_planes}.}
\end{figure}
%\end{landscape}
\clearpage
...
\begin{landscape}
  \begin{figure}[ht]
  \vbox{\vspace{-.5cm}
      \hbox{\includegraphics[width=.45\textwidth, height=.45\textwidth]{./Pics1/3D_Channel/3D_channel_sat_adapt_30.pdf} 
      ...
      \hbox{\hspace{3.cm} (d) t=1.00s \hspace{3.cm} (e) t=1.35s\hspace{4.cm} (f) t=3.50s }}
\caption{\red{For the same time steps as these are shown in figure \ref{fig:3DChannel_sat} there is a partial visual isolation of the preferential path of the flow inside the domain. The aim was to manage and describe the individual finger patterns, as the flow develops, inside the domain. In particular, figures (c)-(f) give a detailed description of the finger that starts to break out of the front}.}
