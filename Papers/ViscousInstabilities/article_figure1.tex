...
%\begin{landscape}
  \begin{figure}[ht]
  \vbox{\vspace{-.5cm}
      \hbox{\hspace{4cm}\includegraphics[width=.5\textwidth]{./Pics1/Section4_4/5r_po_left_inlet_adapt_D250_edb} }
      \vspace{-0.cm}\hbox{\hspace{5cm}(a) saturation (phase 1) }\vspace{-0.cm}
      ...
      \hbox{\hspace{.5cm} \includegraphics[width=.45\textwidth]{./Pics1/Section4_4/5r_po_left_inlet_adapt_D251_Zoom1b}
            \includegraphics[width=.45\textwidth]{./Pics1/Section4_4/5r_po_left_inlet_adapt_D251_Zoom2b.pdf}}
      \vspace{-0.cm}\hbox{\hspace{1cm}(d) Darcy velocity (phase 1) \hspace{1cm}(c) Darcy velocity (phase 2) }\vspace{0.cm} }
