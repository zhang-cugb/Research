...
%}
%}     
\caption{Impact of mesh resolution on capturing flow instabilities: (a) sketch of the computational domain (dimensions in cm); (b) permeability $\left(\text{cm}^{2}\right)$, and; (c) initial saturation and  mesh resolution used in the simulations performed in Section~\ref{section:results_hete_fix_adapt}. There are 13068 \PN[1]{2} element-pairs in the domain.}
