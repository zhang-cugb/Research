...
\begin{figure}[ht]
\vbox{\vspace{-.5cm}
      \hbox{\includegraphics[width=\textwidth]{./Pics1/3D_Channel/3D_channel_elem_planes_1.pdf} }
      \hbox{\hspace{5.0cm} }}
\caption{ XY and YZ planes in the middle of the domain at the end of simulation \red{t=$4.3$sec, but am I reading something wrong?} }
\label{fig:3DChannel_elem_planes}
\end{figure}
%\end{landscape}
\clearpage
...
\caption{ contours of Darcy velocity in XY and YZ planes for (a) t=$$s and (b)t=$$s.}
...
\caption{For the same time steps as in Figure \ref{fig:3DChannel_darcy_vel} there is a description of the saturation front in (a) t=$$s and (b)t=$$s.}
