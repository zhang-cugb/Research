...
%%%
  \begin{figure}[ht]
  \vbox{\vspace{-.5cm}
      \hbox{\includegraphics[width=\textwidth]{./Pics1/3D_Channel/Test_SlowNew_MeshPermeability} }
      \hbox{\hspace{1.0cm} (a) permeability map }}
\caption{3D channel flow \red{FIGS AND COMMENTS TO BE ADDED AS SOON AS THE SIMULATION FINISHES}. The domain contains 243056 \PN[1]{1} element-pairs.}
