...
\caption{Initial model validation: snapshots of numerical simulations performed with VR=1 and VR=10. The domain contains $4678$ elements.(\blue{this is a different set of simulation, we might have to change it and bring between the  })}
