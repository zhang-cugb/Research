...
%}
%}     
\caption{Impact of mesh resolution on flow instabilities: (a) permeability and (b) initial saturation with initial grid resolution used in the simulations performed in Section~\ref{section:results_hete_fix_adapt}. There are 13068 \PN[1]{2} element-pairs in the domain.}
...
\caption{Impact of mesh resolution on flow instabilities:}
...
\caption{Impact of mesh resolution on flow instabilities: mesh resolution \red{JG: add here some comments ... this pic needs to be placed after the sat plots for the adaptivity case ...}}
...
\begin{landscape}
  ...
  \vbox{\vspace{-.5cm}
      \hbox{
            \includegraphics[width=.5\textwidth]{./Pics1/Section4_4/5r_po_left_inlet_adapt_D251_nomeshb}
            \includegraphics[width=.5\textwidth]{./Pics1/Section4_4/5r_po_left_inlet_adapt_D251b} }
      \vspace{0.5cm}
      \hbox{\hspace{.5cm} \includegraphics[width=.5\textwidth]{./Pics1/Section4_4/5r_po_left_inlet_adapt_D251_Zoom1b}
            \includegraphics[width=.5\textwidth]{./Pics1/Section4_4/5r_po_left_inlet_adapt_D251_Zoom2b.pdf}}}
\caption{Impact of mesh resolution on flow instabilities: }
