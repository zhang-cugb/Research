...
\begin{figure} 
   \vbox{
      \hbox{\hspace{3cm}
           \includegraphics[width=0.5\textwidth]{./Pics1/Saffman_homogeneous_MR3/saffman_homo_fixed_1000.pdf}}
          \vspace{.1cm}
             \hbox{\hspace{4cm}(a) flow at t=1000}
           \vspace{1.cm}
      \hbox{\hspace{3cm}
           \includegraphics[width=0.5\textwidth]{./Pics1/Saffman_homogeneous_MR3/saffman_homo_fixed_2500.pdf}}
          \vspace{.1cm}
             \hbox{\hspace{4cm}(a) flow at t=2500}}
      \caption{As the flow progress, t=1000(a), a tip start to appears, at t=2500(b)}\label{fig:1b_homoheleshaw_3}
\end{figure}
...
\vspace{0.0cm}
\hbox{\hspace{4.5cm} (a) Hele-Shaw cell domain   
}
\vspace{0.25cm}
\hbox{\hspace{3.5cm}
...
\vspace{0.0cm}
\hbox{\hspace{5.0cm} (a) Hele-Shaw cell domain   
}
\vspace{0.25cm}
\hbox{\hspace{3.5cm}
...
\vspace{0.25cm}
\hbox{\hspace{1.5cm}
\includegraphics[width=.75\textwidth]{./Pics/4r_po_adapt_fine_125_mesh.pdf}
}
\vspace{0.0cm}
\hbox{\hspace{6.5cm} (b)      
}
...
\vbox{
\hbox{\hspace{1.5cm}
\includegraphics[width=.75\textwidth]{./Pics1/mr10_5regions_fixed/5regions_fixed_250.pdf} 
}
\vspace{0.0cm}
...
\vspace{0.25cm}
\hbox{\hspace{1.5cm}
\includegraphics[width=.75\textwidth]{./Pics1/mr10_5regions_adapt/5regions_adapt_250.pdf}
}
\vspace{0.0cm}
\hbox{\hspace{5.0cm} (b) flow at t=250     
}
...
\vbox{
\hbox{\hspace{1.5cm}
\includegraphics[width=.75\textwidth]{./Pics1/mr10_5regions_fixed/5regions_fixed_500.pdf} 
}
\vspace{0.0cm}
\hbox{\hspace{5.0cm} (a) flow at t=500   
}
\vspace{0.25cm}
\hbox{\hspace{1.5cm}
\includegraphics[width=.75\textwidth]{./Pics1/mr10_5regions_adapt/5regions_adapt_500.pdf}
}
\vspace{0.0cm}
\hbox{\hspace{5.0cm} (b) flow at t=500     
}
}     
