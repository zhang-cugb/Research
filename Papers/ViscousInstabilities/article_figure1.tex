...
\caption{Impact of mesh resolution on flow instabilities: Capture of flow instabilities at interfaces in two regions of the computational domain, {\it A} and {\it B}, in simulations conducted with fixed and adaptive mesh. }
