...
\begin{table}
  \begin{tabular}{c | c c  c  c  c  c  c  c  c  c   c}
    ...
    \hline
     ...
     \ref{section:results_homo_hete}(homogenous)  & 0.2 & 10.0 & 0.0 & 1.0 & 1$*10^{-10}$ & N/A & N/A & N/A & 0.2 & 0.3 & 0.5  \\
     \ref{section:results_homo_hete}(heterogenous) & 0.2 & 1.0 & 0.0 & 1.0 & 1$*10^{-11} $-- & 1$*10^{-12}$ -- & 1$*10^{-12}$ -- & 1$*10^{-10}$ & 0.2  & 0.3 & 1.0 \\
      &   &  &  &  & 5$*10^{-10}$ & 5$*10^{-10}$ & 1$*10^{-10}$  &  &  &  & \\
