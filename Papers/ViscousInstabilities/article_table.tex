...
\begin{table}
  \begin{tabular}{c | c c  c  c  c  c  c  c  c  c   c}
    ...
    \hline
     ...
     \ref{section:results_dinlet}  & 0.2 & 1.0 & 0.0 & 1.0 & 3.0 & 2.0 & 5.0 & 1.0 & 0.2  & 0.3 & 0.5  \\
     \hline
   \end{tabular}
   \caption{Sumary of model set-up used in the numerical simulations. Superscript $\circ$ denotes initial condition. $\mathbf{K}_{i}$ is in $m^{2}$ and $u^{\circ}_{w}$ is in m/sec (units). $S_{w,irr}$ and $S_{nw,r}$ are the same for all simulations. }
\label{table:setup}
\end{table}
\end{landscape}
\clearpage
