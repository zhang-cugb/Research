...
Numerical simulations performed for this work were conducted with the next generation reservoir simulator IC-FERST model\footnote{\href{http://multifluids.github.io}{http://multifluids.github.io}}. A full description of the model can be found in \citet{gomes_2017,jackson_2015,pavlidis2016} \citep[see also][]{porosity_documentation,fluidity_manual}
