...
\medskip
In order to investigate the impact of medium heterogeneity on formation and growth of viscous fingers, a numerical simulation was conducted using a distribution of permeability ({\bf K}) ranging from 1.0$\times$10$^{-12}$ to 5.0$\times$10$^{-10}$ cm$^{2}$ (\ie 0.1 $\le$ {\bf K} $\le$ 50 milidarcy).
