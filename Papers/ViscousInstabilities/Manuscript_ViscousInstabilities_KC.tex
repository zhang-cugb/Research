...
\KCnote{\blue{need to put screenshots from pseudo hele-shaw case - log on to Jeff's station and then include the following cases}}





Having already verified that model is working for the test-cases illustrated in previous section, now a more complicated case will be introduced with regions of different geometrical domains and different permeabilities. Figure \ref{fig:testcase_heter_domain} gives a description of the domain that will be used.
