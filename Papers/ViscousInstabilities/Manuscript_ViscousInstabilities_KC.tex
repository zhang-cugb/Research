...
A distinction should also be made between microscopic and macroscopic instabilities. The first describe phenomena occurring locally, for example, Kelvin-Helmholtz and Saffman-Taylor instabilities \citep{saffman_1959}. On the other hand, macroscopic instabilities involve two-phase flow system \citep{bottoni_1992}. This paper will focus on microscopic instabilities and phenomena in two-phase systems while a this work will focus on a local flow instability due to viscous and stress forces, often referred as viscous instability or \textit{viscous fingering}.
