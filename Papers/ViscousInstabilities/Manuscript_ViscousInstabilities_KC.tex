...
\end{equation}
In Eqn.~\ref{eq:capillary_number}, $\gamma$ is the surface tension and $U$ is the characteristic velocity of the moving interface. In Hele-Shaw cells, a fluid is introduced between two parallel flat plates separated by an infinitesimally small gap. This experimental apparatus enables instabilities to be qualitatively investogated by simplifying the flow problem in both porous and non-porous media.   
