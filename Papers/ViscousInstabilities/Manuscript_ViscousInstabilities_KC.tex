...
Here, 2D simulations were conducted in a 5$\times$5 unit-length domain (Fig.~\ref{fig:homoheleshaw}a) fully saturated with a fluid. Wetting phase fluid is driven from the bottom left-hand corner of the domain with velocity of $\frac{\sqrt{2}}{2}$. Newmann boundary condition (\ie no flux) was imposed to all borders of the domain except at the top right-hand corner (named as sink). Viscosity ratios for this set of simulations are 3 and 10.
