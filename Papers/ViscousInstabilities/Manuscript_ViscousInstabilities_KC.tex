...
\red{KOSTAS: Conclusions of numerical modelling papers are are often very short and divided into 3 parts: (1) Short (1 paragraph) summary of the paper with focus on the main theoretical aspects that were proved by \underline{your work} in the present manuscript; (2) Summary (1-3 paragraphs) of the main results with the appropriate analysis (\ie how you work has proved the theory); and (3) (optional) 1 paragraph of potential future work. Make sure that (1) and (2) are covered in the present Section.}  
