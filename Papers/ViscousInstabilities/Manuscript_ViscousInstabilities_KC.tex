...
\label{eq:MR}
\end{equation}
MR is a function not only of fluid viscosities and saturations, but also the parameterised relative permeability, $\mathcal{K}_{r\alpha}$, often expressed as a function of the residual and maximum phase saturation prescribed in the pore rock matrix.
