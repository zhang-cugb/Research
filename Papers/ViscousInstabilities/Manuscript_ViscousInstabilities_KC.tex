...
\includegraphics[width=0.49\textwidth]{./Pics1/mr10_5regions_fixed/5regions_fixed_250.pdf}%
}%
\hfill    
\subfigure[MR10 adapt mesh start]{%
\includegraphics[width=0.49\textwidth]{./Pics1/mr10_5regions_adapt/5regions_adapt_250.pdf}%
}}\\[0.5cm]% If you want some vertical space
\makebox[\textwidth]{%
\subfigure[MR10 fixed mesh]{%
\includegraphics[width=0.49\textwidth]{./Pics1/mr10_5regions_fixed/5regions_fixed_500.pdf}%
}%
\hfill    
\subfigure[MR10 adapt mesh]{%
\includegraphics[width=0.49\textwidth]{./Pics1/mr10_5regions_adapt/5regions_adapt_500.pdf}%
}}\\[0.5cm]% If you want some vertical space
\makebox[\textwidth]{%
\subfigure[MR10 fixed mesh]{%
\includegraphics[width=0.49\textwidth]{./Pics1/mr10_5regions_fixed/5regions_fixed_1500.pdf}%
}%
\hfill    
\subfigure[MR10 adapt mesh]{%
\includegraphics[width=0.49\textwidth]{./Pics1/mr10_5regions_adapt/5regions_adapt_1500.pdf}%
}}\\[0.5cm]% If you want some vertical space
\makebox[\textwidth]{%
\subfigure[MR10 fixed mesh end]{%
\includegraphics[width=0.49\textwidth]{./Pics1/mr10_5regions_fixed/5regions_fixed_2000.pdf}%
}%
\hfill    
\subfigure[MR10 adapt mesh end]{%
\includegraphics[width=0.49\textwidth]{./Pics1/mr10_5regions_adapt/5regions_adapt_3000.pdf}%
}}%
