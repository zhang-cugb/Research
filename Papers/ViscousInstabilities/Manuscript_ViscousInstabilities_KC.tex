...
This example serves as a base case for comparison between mobility ratios that differ by an order of magnitude. In general for mobility ratios below $5$ no fingers are expexted as the injection fron will uniformly develop as time progress. Instabilities will start to occur for mobility ratios higher than $5$. Triggered from permeability differences the front will start to collapse initially at the upper layers of the domain. Capilary pressure and therefore surface tension at the interface between two immiscible fluids is a factor that may affect negative the productivity of an oil field.
