...
\end{center}
\caption{Comparing the  MR=$10$ cases for both fixed and adaptive mesh for the same time steps, t=100(a,b), t=2500(c,d), t=7500(e,f), t=10000(g,h)}
\label{fig:2testcase}
\end{figure}
...
The thirs test case is a comparison between 2 element types, while the set up of the problem remains the same, the mobility ratio is $10$, and the adaptive and ustructured mesh is implied. 
