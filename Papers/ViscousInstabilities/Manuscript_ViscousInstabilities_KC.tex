...
In order to investigate the impact of viscosity ratio on flow behaviour, numerical simulations of fluid displacement were conducted in Hele-shaw cells (\ie parallel flat plates separated by infinitesimal space) following \citet{saffman_1986} work. In this work, he investigated the onset of viscous flow instabilities \citep[following his seminal work in][]{saffman_1958} and the impact of boundary conditions in the problem formulation and solution.

Here, 2D simulations are conducted in 5$\times$5 domain, Fig.~\ref{fig:homoheleshaw}(a) fully saturated with a fluid. Wetting phase fluid is injected from the bottom left-hand corner of the domain with velocity of $\frac{\sqrt{2}}{2}$. A zero-flux condition was applied to all boundaries, except the top right-hand corner (named as sink).
XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX
 of the problem. formation and stability of viscous flow instaseminal work of \citet{saffman_1986}
