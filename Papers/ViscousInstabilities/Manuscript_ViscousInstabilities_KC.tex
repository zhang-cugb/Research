...
\medskip
As can been seen from the fig.\ref{fig:1a_homoheleshaw_3}-\ref{fig:1c_homoheleshaw_3} there is a significant difference on the flow pattern when the mobility ratio is $3$ and when it is $10$ under the same number of elements. %Figures \ref{fig:1a_homoheleshaw_3}, \ref{fig:1b_homoheleshaw_3}, \ref{fig:1c_homoheleshaw_3} 
