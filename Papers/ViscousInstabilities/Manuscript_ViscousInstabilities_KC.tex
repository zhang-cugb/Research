...
while saturation is represented in node centered CV basis functions.  Saturation equations are solved explicitly after solving for pressure at each non-linear iteration~\citep[a detailed description of the implicit pressure explicit saturation, IMPES, formulation can be found in][]{lux_2012,chen_2006}.
