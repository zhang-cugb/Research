...
We examine the flow instabilities, \ie viscous fingering on the displacement of one fluid by a second, using a novel computational method for modeling multi-phase flows in heterogeneous porous media. Those "fingers" will multiply and develop further into complex networks that will eventually affect the efficiency of field operations.    
