...
\label{fig:}
\includegraphics[width=0.35\textwidth]{./Pics1/mr1_fixed/mr1_fixed_500.png}
}%
\subfigure[MR10 fixed mesh 500]{%
\label{fig:}
\includegraphics[width=0.35\textwidth]{./Pics1/mr10_fixed/mr10_fixed_500.png}
}\\
\subfigure[MR1 fixed mesh half]{%
\label{fig:}
\includegraphics[width=0.35\textwidth]{./Pics1/mr1_fixed/mr1_fixed_1500.png}
}%
\subfigure[MR10 fixed mesh half]{%
\label{fig:}
\includegraphics[width=0.35\textwidth]{./Pics1/mr10_fixed/mr10_fixed_5000.png}
}\\ 
\subfigure[MR1 fixed mesh end]{%
\label{fig:}
\includegraphics[width=0.35\textwidth]{./Pics1/mr1_fixed/mr1_fixed_end.png}
}\\
\subfigure[MR10 fixed mesh end]{%
\label{fig:}
\includegraphics[width=0.35\textwidth]{./Pics1/mr10_fixed/mr10_fixed_10000.png}
}\\
\end{center}
\caption{Comparing MR1 and MR10 cases -fixed mesh- for the same time steps}
\label{fig:}
\end{figure}
