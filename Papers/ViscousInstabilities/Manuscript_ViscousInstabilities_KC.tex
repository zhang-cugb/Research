...
A two-phase immiscible flow along homogeneous and parallel layers of contrasting permeability is initially simulated. During fluid displacement, crossflow between adjacent layers often occur due to viscous, capillary and/or gravitational forces in discontinuous spatial permeability distribution. Such preferential flows are shown in Fig.~\ref{DaweGrattoniExperiment_b}. In this case, crossflow behaviour from first to fourth quadrants of the domain is in good qualitative agreement with experiments conducted by \citet{dawe_2008}, Fig.~\ref{DaweGrattoniExperiment_a}(b). 
