...
\red{In Figures \ref{fem_cv_represent_vr1_vr10} there is a different set of simulations. There is a comparison between the $VR=1$ and $VR=10$ case and the reason was to imply the same domain, boundary and initial conditions and number of elements to underastand how the cross-flow will develop. The purpose of these two cases was to verify that the model is working for cross flow cases thus will allow to proceed further and expand this technique into more complex formations.}    
