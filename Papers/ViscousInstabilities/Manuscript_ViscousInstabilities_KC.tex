...
From Eqns.~\ref{eq:MR}-\ref{Eqn:CoreyBrooks2}, it is clear that during fluid displacement, the mobility ratio changes as phase saturation, $S_{w}\left(x_{i},t\right)$ and $S_{nw}\left(x_{i},t\right)$, varies in time and space (Eqn.~\ref{eqn:saturation_eqn}). Therefore, with no lack of generality, the MR can be reduced to
\begin{displaymath}
    \text{MR} = \frc{\mu_{i}}{\mu_{j}},
\end{displaymath}
 i.e., the viscosity ratio. Analysis performed in the following sections will make use of this simplified definition as phase saturation is a prognostic field that is calculated along with pressure and velocity. \red{(PARAGRAPH NEEDS TO BE IMPROVED)} 
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% 
\section{Model Validation}\label{section:validation:results}

Numerical simulations performed for this work were conducted with the next generation reservoir simulator IC-FERST model\footnote{\href{http://multifluids.github.io}{http://multifluids.github.io}} \citep[a full description of the model can be found in][]{gomes_2017,jackson_2013,porosity_documentation,fluidity_manual}. This multi-physics model has been validated against traditional multi-fluids test-cases (e.g., Buckley-Leverett problem, channel model, immiscible displacement, gravity-driven displecement, viscous crossflow etc) in \citet{jackson_2015,pavlidis2016,salinas2015,salinas_2016,adam_2016b,su_2015,radunz_2014}. Two test-cases
