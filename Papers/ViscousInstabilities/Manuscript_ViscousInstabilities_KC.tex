...
%% \fntext[label3]{}
  ...
  \title{ Numerical Investigation of Viscous Flow Instabilities in Heterogeneous Porous Media}%. Advantages and limitations of unstructured and adaptive meshes in 2D and 3D domains under different mobility scenarios.}
...
\end{equation}
where $\mu$ is the viscosity of the fuid, $\gamma$ is the surface tension and $U$ is a velocity characteristic of the moving interface.

\medskip
In Hele-Shaw cells, a fluid is introduced between two parallel flat plates separated by an infinitesimally small gap. The experimental apparatus allows the predicted instability to be verified qualitatively and simplifies the problem of flow in both porous and non-porous media.   
