...
Multiphase flow in porous media is described by mass conversation and Darcy equations for all the phase $\alpha$ ($\alpha$ = g, o, w, for gas, oil, and water phases).
...
\begin{figure}[h]
\makebox[\textwidth]{%
\includegraphics[width=0.39\textwidth]{./Pics/2b2_P1DGP2_perm}%
\hfill    
\includegraphics[width=0.39\textwidth]{./Pics/2b2_P1DGP2_mesh}%
}\\[0.5cm]% If you want some vertical space
\makebox[\textwidth]{%
\includegraphics[width=0.5\textwidth]{./Pics/2b2_P1DGP2_plot}%
}%
...
\label{fig:}
\includegraphics[width=0.45\textwidth]{./Pics1/2b2_wi_fine/2b2_whole_in_fine_250_1.png}
}%
\subfigure[MR1 fixed mesh end aspect ratio 2]{%
\label{fig:}
\includegraphics[width=0.45\textwidth]{./Pics1/2b2_wi_fine/2b2_whole_in_fine_3000_1.png}
}\\
\end{center}
...
\label{fig:}
\includegraphics[width=0.45\textwidth]{./Pics/P1DG-P2_element_type}
}%
\subfigure[The map of permeabilities]{%
\label{fig:}
\includegraphics[width=0.45\textwidth]{./Pics/4r_po_adapt_fine_125_mesh}
}\\
\end{center}
