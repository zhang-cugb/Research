...
\textcolor{blue}{Accurate simulation of multiphase flows in porous media remains a challenge. While the governing equations are the conservation of mass and Darcy's law, there are also the primary variables, such us pressure, velocity, saturation and permeability. This paper introduce a multi-fluid porous media flow model which is the basis of a reservoir simulator, as implemented in Fluidity, a general purpose flow simulator that is equipped with anisotropic mesh adaptivity techniques to control the local solution errors and  increase the computational accuracy in the research on the development of numerical methods in geophysical fluid mechanics. The governing multiphase porous media flow equations are solved using the adaptive and unstructured mesh.
...
Numerical investigation and modelling of multiphase flows in porous media have attracted the attention of the scientific community over the past 40 years. This is mainly due to applications on oil and gas recovery, groundwater exploration, underground coal gasification, and more recently on CO$_{\text{2}}$ migration and trapping mechanisms in carbon capture and storage (CCS) operations~\citep{spycher_2003, chen_2006, self_2012, pruess_1990c, white_1981,jiang_2011} as well as in groundwater operations. 

For reservoir engineers and hydrogeologists, mapping the behaviour of multiphase flows and predict the response of the system is a major challenge followed by complex geometries with irregular boundaries and heterogeneous geological formations. These are some of the main challenges for accurately forecasting the behaviour of flows into porous media. Both Permeability and porosity are important parameters in the equations used for numerical simulation of multiphase flow in porous media. %Heterogeniety of permeability and porosity is a product of the medium's formation process %-- deposition and diagenesis -- and exists at different scales. 
At the microscopic level, the continuum approach can be applied to a representative elementary Volume (REV) to define these parameters~\citep{bastian_phd1999}. This is well suited for analysis of small scales such as core samples. 

Although parallel processing is available nowadays, a fine-scale geological model is far too detailed to be accumulated by common reservoir simulators, mainly because of the processing time.
...
\begin{figure}[h]
\makebox[\textwidth]{%
\includegraphics[width=0.49\textwidth]{2b2_P1DGP2_perm}%
\hfill    
\includegraphics[width=0.49\textwidth]{2b2_P1DGP2_mesh}%
}\\[0.5cm]% If you want some vertical space
\makebox[\textwidth]{%
\includegraphics[width=0.75\textwidth]{2b2_P1DGP2_plot}%
}%
\caption{ Caption 1}
\label{fig:1}
\end{figure}
...
\begin{center}
\centering
\includegraphics[width=0.75\linewidth, height=5cm]{P1DG-P2_element_type} 
\caption{Caption 2}
\label{fig:2}
\end{center}
...
\begin{center}
\centering
\includegraphics[width=0.8\linewidth, height=7cm]{4r_po_adapt_fine_125_mesh} 
\caption{Caption 3}
\label{fig:3}
\end{center}
...
\begin{center}
\centering
\includegraphics[width=0.8\linewidth, height=7cm]{4r_po_adapt_fine_100_mesh}
\caption{Caption 4}
\label{fig:4}
\end{center}
...
\label{fig:1st}
\includegraphics[width=0.75\textwidth]{4r_po_adapt_fine_100}
}%
\subfigure[MR100, at the middle of the simulation]{%
\label{fig:2nd}
\includegraphics[width=0.75\textwidth]{4r_po_adapt_fine_125_phase1_vol_fraction_mesh}
}\\
\subfigure[MR100, Phase 1 Volume fraction]{%
\label{fig:3rd}
\includegraphics[width=0.75\textwidth]{4r_po_adapt_fine_125_phase1_vol_frac}
}%
\subfigure[MR100, Phase 2 Volume fraction]{%
\label{fig:4th}
\includegraphics[width=0.75\textwidth]{4r_po_adapt_fine_125_phase2_vol_fraction}
}\\
...
\label{fig:second}
\includegraphics[width=0.52\textwidth]{Recovery_MR1_1.png}
}\\
\subfigure[MR10]{%
\label{fig:first}
\includegraphics[width=0.7\textwidth]{MR10.png}
}%
\subfigure[Recovery for MR10]{%
\label{fig:second}
\includegraphics[width=0.52\textwidth]{Recovery_MR10_10.png}
}\\
\subfigure[MR100]{%
\label{fig:first}
\includegraphics[width=0.7\textwidth]{MR100_100_start.png}
}%
\subfigure[Recovery for MR100]{%
\label{fig:second}
\includegraphics[width=0.52\textwidth]{Recovery_MR100_100.png}
}\\ 
\end{center}
\caption{Comparison of different MR's and their recovery rates}
\label{fig:6}
