...
In order to investigate the impact of viscosity ratio on flow behaviour, numerical simulations of fluid displacement were conducted in Hele-shaw cells (\ie parallel flat plates separated by infinitesimal space) following work by \citet{saffman_1986}. In this manuscript, he investigated the onset of viscous flow instabilities \citep[following his seminal work in][]{saffman_1958} and the impact of boundary conditions in the problem mathematical formulation and solutions.
