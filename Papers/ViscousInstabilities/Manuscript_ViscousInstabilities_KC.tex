...
\medskip
Viscous flow instabilities can be found across several disciplines and scales, from chemical separation processes to geological reservoir fluids. \citet{muskat_1934} investigated the flow of a fluid injected between two infinite parallel plates (Hele-Shaw cell) and the impact on capillary number ($N_{c}$),
\begin{equation}
