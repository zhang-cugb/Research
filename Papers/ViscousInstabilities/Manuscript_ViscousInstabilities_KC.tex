...
The study of viscous flow instabilities (\ie fingering) is particularly important in oil exploration due to heterogeneities (\ie natural fractures, different permeability characteristics in different zones) of geological formations that may affect the oil production. Important factors during flooding operations are the volumetric sweep efficiency, or the ration of volumes between the recovered and the injected fluids as well as the breakthrough of injected fluid. A major problem associated with water-flooding projects is the early water-breakthrough, the main causes of which are high-permeability layers and unfavorable mobility ratios. Water breakthrough is the main determinant of the productive life of the reservoir \citep{riaz_2004, tavassoli_2015}. During immiscible CO$_{2}$ flooding $\left(\text{\eg in CO}_{2}\text{ enhanced oil recovery, CO}_{2}\text{-EOR, processes}\right)$, density of supercritical CO$_{2}$ is usually lower than hydrocarbons, thus viscous fingering and/or channelling may occur.

\medskip
The displacement efficiency depends upon the ratio of the viscous to capillary forces or capillary number ($N_{c}$, see eq.\ref{eq:capillary_number}). 
