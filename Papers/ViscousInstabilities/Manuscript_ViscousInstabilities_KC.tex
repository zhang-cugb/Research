...
Numerical simulations performed for this work were conducted with the next generation reservoir simulator IC-FERST model\footnote{\href{http://multifluids.github.io}{http://multifluids.github.io}} \citep[a full description of the model can be found in][]{gomes_2017,porosity_documentation,fluidity_manual}

%,jackson_2015,pavlidis2016
