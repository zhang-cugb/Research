...
\end{center}
\caption{Comparing the  MR=$10$ cases for both fixed and adaptive mesh for the same time steps, t=100(a,b), t=1500(c,d), t=7500(e,f), t=10000(g,h)}
\label{fig:3testcase}
\end{figure}
...
\subfigure[MR10 fixed mesh start]{%
\label{fig:}
\includegraphics[width=0.35\textwidth]{./Pics1/}
}\\
\subfigure[MR1 fixed mesh 500]{%
\label{fig:}
\includegraphics[width=0.35\textwidth]{./Pics1/mr10_5regions_adapt/5regions_adapt_500.png}
...
The thirs test case is a comparison between the previous case and a new one with double inlet. This time Fluid &1& is injected from both th elrfta hand side and the upper left corner of the domainwhile the set up of the problem remains the same, the mobility ratio is $10$, and the adaptive and ustructured mesh is implied. 
