...
Numerical simulations performed in this section were conducted with the next-generation reservoir simulator IC-FERST model\footnote{\href{http://multifluids.github.io}{http://multifluids.github.io}} \citep[a full description of the model can be found in][]{gomes_2017,jackson_2013,porosity_documentation,fluidity_manual}. This multi-physics model has been validated against traditional multi-fluids test-cases (e.g., Buckley-Leverett problem, channel model, immiscible displacement, gravity-driven displacement etc) in \citet{jackson_2015,pavlidis2016,salinas2015,salinas_2016,adam_2016b,su_2015,radunz_2014}. 
