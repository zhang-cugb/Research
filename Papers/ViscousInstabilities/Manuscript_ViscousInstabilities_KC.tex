...
\noindent The saturations are computed in CV space, whereas the permeability tensor $\left(\mathbf{K}\right)$ is assumed piece-wise constant in FE space. Thus the viscous-friction damping tensor $ {\underline {\underline \sigma}}_{\alpha}$ is piece-wise constant within the sub-control volumes defined through intersections between the elements and control volumes.
...
In the CVFE method pressure is interpollated using piecewise linear finite element basis functions (see Eq.\ref{v_and_p}, also known as shape functions, $\underline{\bf v}$ and $\underline{\bf p}$) while saturation is represented in node centered CV basis functions respectevely, and the saturation equation is solved explicitly after solving for pressure at each time.
...
%where $N_{\alpha}$ is first order finite element basis function and $M_{b}$ is the control volume basis function that is equal to unity over the control volume constructed around node j and is equal to zero everywhere else. 
...
\begin{figure}[h]
\makebox[\textwidth]{%
\includegraphics[width=0.39\textwidth]{./Pics/2b2_P1DGP2_perm.pdf}%
\hfill    
\includegraphics[width=0.39\textwidth]{./Pics/2b2_P1DGP2_mesh.pdf}%
}\\[0.5cm]% If you want some vertical space
\makebox[\textwidth]{%
\includegraphics[width=0.5\textwidth]{./Pics/2b2_P1DGP2_plot.pdf}%
}%
...
\begin{figure}[h]
\begin{center}
\subfigure[MR1 fixed mesh start aspect ratio 2]{%
\label{fig:}
\includegraphics[width=0.45\textwidth]{./Pics1/2b2_wi_fine/2b2_whole_in_fine_250_1.pdf}
}%
\subfigure[MR1 fixed mesh end aspect ratio 2]{%
\label{fig:}
\includegraphics[width=0.45\textwidth]{./Pics1/2b2_wi_fine/2b2_whole_in_fine_3000_1.pdf}
}\\
\end{center}
...
\begin{figure}[h]
\begin{center}
\subfigure[The $P_{1}DGP_{2}$ element type]{%
\label{fig:}
\includegraphics[width=0.45\textwidth]{./Pics/P1DG-P2_element_type.pdf}
}%
\subfigure[The map of permeabilities]{%
\label{fig:}
\includegraphics[width=0.45\textwidth]{./Pics/4r_po_adapt_fine_125_mesh.pdf}
}\\
\end{center}
...
\label{fig:}
\includegraphics[width=0.35\textwidth]{./Pics1/mr1_fixed/mr1_fixed_100_2.pdf}
}%
\subfigure[MR10 fixed mesh start]{%
\label{fig:}
\includegraphics[width=0.35\textwidth]{./Pics1/mr10_fixed/mr10_fixed_100_1.pdf}
}\\
\subfigure[MR1 fixed mesh middle]{%
\label{fig:}
\includegraphics[width=0.35\textwidth]{./Pics1/mr1_fixed/mr1_fixed_middle_1.pdf}
}%
\subfigure[MR10 fixed mesh middle]{%
\label{fig:}
\includegraphics[width=0.35\textwidth]{./Pics1/mr10_fixed/mr10_fixed_middle_1.pdf}
}\\
\subfigure[MR1 fixed mesh end]{%
\label{fig:}
\includegraphics[width=0.35\textwidth]{./Pics1/mr1_fixed/mr1_fixed_end_2.pdf}
}\\
\subfigure[MR10 fixed mesh end]{%
\label{fig:}
\includegraphics[width=0.35\textwidth]{./Pics1/mr10_fixed/mr10_fixed_end_2.pdf}
}\\
\end{center}
...
\subfigure[MR10 fixed mesh start]{%
\label{fig:first}
\includegraphics[width=0.35\textwidth]{./Pics1/mr10_5regions_fixed/5regions_fixed_250.pdf}
}%
\subfigure[MR10 adapt mesh start]{%
\label{fig:}
\includegraphics[width=0.35\textwidth]{./Pics1/mr10_5regions_adapt/5regions_adapt_250.pdf}
}\\
\subfigure[MR10 fixed mesh]{%
\label{fig:}
\includegraphics[width=0.35\textwidth]{./Pics1/mr10_5regions_fixed/5regions_fixed_500.pdf}
}%
\subfigure[MR10 adapt mesh]{%
\label{fig:}
\includegraphics[width=0.35\textwidth]{./Pics1/mr10_5regions_adapt/5regions_adapt_500.pdf}
}\\
\subfigure[MR10 fixed mesh]{%
\label{fig:}
\includegraphics[width=0.35\textwidth]{./Pics1/mr10_5regions_fixed/5regions_fixed_1500.pdf}
}%
\subfigure[MR10 adapt mesh]{%
\label{fig:}
\includegraphics[width=0.35\textwidth]{./Pics1/mr10_5regions_adapt/5regions_adapt_1500.pdf}
}\\ 
\subfigure[MR10 fixed mesh end]{%
\label{fig:}
\includegraphics[width=0.35\textwidth]{./Pics1/mr10_5regions_fixed/5regions_fixed_2000.pdf}
}\\
\subfigure[MR10 adapt mesh end]{%
\label{fig:}
\includegraphics[width=0.35\textwidth]{./Pics1/mr10_5regions_adapt/5regions_adapt_3000.pdf}
}\\
\end{center}
...
\subfigure[MR10 fixed mesh start]{%
\label{fig:}
\includegraphics[width=0.35\textwidth]{./Pics1/mr10_5regions_fixed_dinlet/5regions_dinlet_fixed_100.pdf}
}%
\subfigure[MR10 fixed adapt start]{%
\label{fig:}
\includegraphics[width=0.35\textwidth]{./Pics1/mr10_5regions_adapt_dinlet/5regions_dinlet_adapt_start.pdf}
}\\
\subfigure[MR10 fixed mesh t=1500]{%
\label{fig:}
\includegraphics[width=0.35\textwidth]{./Pics1/mr10_5regions_fixed_dinlet/5regions_dinlet_fixed_500.pdf}
}%
\subfigure[MR10 fixed adapt t=1500]{%
\label{fig:}
\includegraphics[width=0.35\textwidth]{./Pics1/mr10_5regions_adapt_dinlet/5regions_dinlet_adapt_500.pdf}
}\\
\subfigure[MR10 fixed mesh t=7500]{%
\label{fig:}
\includegraphics[width=0.35\textwidth]{./Pics1/mr10_5regions_fixed_dinlet/5regions_dinlet_fixed_2000.pdf}
}%
\subfigure[MR10 fixed adapt t=7500]{%
\label{fig:}
\includegraphics[width=0.35\textwidth]{./Pics1/mr10_5regions_adapt_dinlet/5regions_dinlet_adapt_2000.pdf}
}\\ 
\subfigure[MR10 fixed mesh end]{%
\label{fig:}
\includegraphics[width=0.35\textwidth]{./Pics1/mr10_5regions_fixed_dinlet/5regions_dinlet_fixed_end.pdf}
}\\
\subfigure[MR10 fixed adapt end]{%
\label{fig:}
\includegraphics[width=0.35\textwidth]{./Pics1/mr10_5regions_adapt_dinlet/5regions_dinlet_adapt_end.pdf}
}\\
\end{center}
...
\begin{figure}
\centering
\includegraphics[width=0.5\textwidth]{./Pics1/mr100_fixed/mr100_fixed_500.png}\\[2mm]%
\includegraphics[width=0.5\textwidth]{./Pics1/mr100_fixed/mr100_fixed_1500.png}\\[2mm]%
\includegraphics[width=0.5\textwidth]{./Pics1/mr100_fixed/mr100_fixed_3000.png}\\[2mm]%
\includegraphics[width=0.5\textwidth]{./Pics1/mr100_fixed/mr100_fixed_end.png}%
