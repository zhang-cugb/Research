...
In heterogeneous domains, such instability may also be triggered by permeability differences between smaller regions as is shown in Section XXX. The higher the velocity of the low viscosity fluid, the less wide (tip-splitting behaviour) the finger will be. In addition, pressure differences %(eq.\ref{eq:pressure_dif}) 
