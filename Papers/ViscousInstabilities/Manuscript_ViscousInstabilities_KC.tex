...
A two-phase immiscible flow along homogeneous and parallel layers of contrasting petrophysical properties (\ie permeability) is initially simulated. During fluid displacement, crossflow between adjacent layers often occur due to viscous, capillary and/or gravitational forces in discontinuous spatial permeability distribution. Such preferential flows are shown in Figs.~\ref{fem_cv_represent_a}(b-c). In this case, the crossflow dynamics through first and fourth quadrants of the domain is in good qualitative agreement with experiments conducted by \citet{dawe_2008} (see Figs. 5 and 6 of this reference). 
