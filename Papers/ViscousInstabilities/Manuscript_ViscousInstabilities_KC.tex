...
Figures \ref{fig:5regions_fixedmesh} and \ref{fig:5regions_adaptmesh} show fluid displacement in simulations performed with fixed and adaptive mesh grids over 1.50 seconds. Both simulations started with a mesh of 13068 triangular elements (\PN[1]{2} element-pairs), however as flow dynamics evolves the number of elements of the simulation conducted with adaptive mesh oscillates from a minimum of 4400 to a maximum of 16430 (Fig.~\ref{fig:5regions_plottimenodeselements})
