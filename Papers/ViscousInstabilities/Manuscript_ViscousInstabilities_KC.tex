...
A critical aspect of multiphase flows in porous media is the displacement efficiency that measures the quantity of fluid that can be pushed by another fluid due to pressure gradient. Migration of contaminants and waterflooding/EOR (enhanced oil recovery) are typical applications in which simulation of immiscible fluid displacement dynamics may help mitigating water resources contamination and improving hydrocarbons production. In this work, flow instabilities that arise from fluids' viscosity ratio are numerically investigated. Viscous flow instabilities lead to formation and growth of fingers that have strong impact on the efficiency of oil and gas exploration. 
