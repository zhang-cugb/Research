...
Having already observed the significant growth of fingers for mobility ratios larger than $5$, the next step is a comparison under the same mobility ratio of $10$, using the fixed and the adaptive mesh test case.    
