...
\blue{(a) Little intro of the case; (b) set up what are the main issues (theory) of the simulations you are showing in this section; (c) then briefly describe what are the strategies to tackle these issues; (d) then describe the numerical experiment w all BC and IC; (e) then finally describe the results with a clear conclusion based on observation but backed by theory and/or physics!!}
