...
\vspace{0.cm}
\hbox{\hspace{2.0cm} (a) pressure at t=0 \hspace{5.cm} (b) t=250\red{(???)} \hspace{2.75cm} (c) t=1000\red{(???)}}
\vspace{0.5cm}
\hbox{
...
\vspace{0.cm}
\hbox{ \hspace{1.cm} (d) t=2500\red{(???)} \hspace{2.0cm} (e) t=1000\red{(???)}   \hspace{3.0cm} (f) t=XXX\red{(???)}}
\vspace{0.cm}
}   
